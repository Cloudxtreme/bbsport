...
<%@ include file="/WEB-INF/page/share/basePath.jsp"%>
<html>
<head>
<title>产品类别管理</title>
...
<!---------------------------LOOP START------------------------------>
 <c:forEach items="${pageView.records}" var="entry">
    <tr>
      ...
      <td bgcolor="f5f5f5"> <div align="center"><a href='<html:rewrite action="/control/product/type/list"/>?parentid=${entry.typeid }'>${entry.name }</a></div></td>
